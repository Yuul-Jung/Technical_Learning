...
//
// (변경) no_object 상태 출력을 추가한다.
//
// distance_valid = 1
// -> 정상 거리값이 유효함
//
// no_object = 1
// -> Echo Timeout이 발생한 상태를 유지함
//
// distance_valid = 0, no_object = 0
// -> 측정 전 또는 측정 중
//
// timeout_error는 1Clock Pulse이므로 모터 제어 상태로 직접 사용하기 어렵다.
// no_object는 다음 정상 측정 또는 Enable OFF까지 상태로 유지한다.
